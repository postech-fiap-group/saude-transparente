...
public class GlobalExceptionHandle extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handlePacienteNaoEncontrado(PacienteNaoEncontradoException exception) {
        ErrorMessage threatResponse = new ErrorMessage(HttpStatus.NOT_FOUND, exception.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(threatResponse);
    }

    @ExceptionHandler(PacienteNaoOuNaoPodeCriarException.class)
    public ResponseEntity<ErrorMessage> handlePacienteNaoOuNaoPodeCriar(PacienteNaoOuNaoPodeCriarException exception) {
        ErrorMessage threatResponse = new ErrorMessage(HttpStatus.BAD_REQUEST, exception.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(threatResponse);
    }
